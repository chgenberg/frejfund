...
export default function PitchPingvinen() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center px-4 py-12">
      <h1 className="text-3xl md:text-4xl font-extrabold text-[#16475b] tracking-widest text-center mb-10 mt-2 uppercase">PITCH PENGUIN</h1>
      ...
      <div className="w-full max-w-4xl flex flex-col gap-8">
        ...
        <div className="flex flex-col items-center gap-8 w-full max-w-lg mx-auto mb-2">
          <h2 className="text-2xl font-bold text-[#16475b] mb-6 text-center">Record your pitch</h2>
          <p className="text-gray-200 text-center mb-8">
            Press the microphone and tell your idea in max 20 seconds. The penguin listens and gives you an investor score instantly!
          </p>
          <Image src="/pingvin.png" alt="Pitch Penguin" width={120} height={120} className={listening ? "animate-pulse" : ""} />
          <button
          ...
          {listening && <div className="text-white font-bold animate-pulse mt-2">The penguin is listening...</div>}
        ...
        <div className="bg-[#16475b] text-white rounded-2xl shadow border border-gray-100 p-6 max-w-md mx-auto mt-2">
          <h3 className="text-lg font-bold mb-2 text-center">Need inspiration?</h3>
          <p className="text-white/80 text-center mb-4 text-sm">Let AI create a pitch script for you! Fill in three quick fields and get a ready-made script in 30 seconds.</p>
          <PitchGenerator />
        </div>
      </div>
    </div>
