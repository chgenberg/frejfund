...
export default function MyPages() {
  ...
  // Mock data
  const analyser = [
    { title: "AI for e-commerce", updated: "2024-05-20", percent: 60 },
  ];
  const rapporter = [];
  const inbox = [
    { msg: "Tips: complete the analysis for your first score!", date: "2024-05-21" },
  ];
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center px-2 py-12">
      ...
      <div className="w-full max-w-5xl flex items-center justify-between mb-8">
        ...
        <div className="text-[#16475b] font-bold text-lg tracking-widest uppercase">My Pages</div>
        <button onClick={logout} className="bg-[#16475b] text-white rounded-full px-5 py-2 font-bold shadow hover:bg-[#133a4a] transition-colors">Log out</button>
      </div>
